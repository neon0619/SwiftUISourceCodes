...
class NetworkingManagerTests: XCTestCase {
    ...
    func test_with_successful_response_that_response_is_valid() async throws {
        ...
        let staticJson = try StaticJSONMapper.decode(file: "UsersStaticData", type: UsersModel.self)
        
        XCTAssertEqual(res, staticJson, "The returned response should be decoded properly")
    }
    
    // POST
    func test_with_successful_response_that_void_is_valid() async throws {
    ...
    //POST
    func test_with_unsuccessful_response_code_void_in_invalide_range_is_invalid() async {
