...
//  SwiftUISourceCodesUITests
//
//  Created by Christopher Castillo on 9/24/22.
//

import XCTest

final class DetailsSuccessUITests: XCTestCase {
    ...
    override func setUp() {
        ...
        app.launchEnvironment = ["-people-networking-success":"1", "-details-networking-success":"1"]
        app.launch()
    }
